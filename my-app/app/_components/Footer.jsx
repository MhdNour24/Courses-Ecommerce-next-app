    ...
    <footer className="mt-32 bg-gray-100">
      <div className="max-w-5xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        ...
        <ul className="flex justify-center gap-6 mt-12 md:gap-8">
          ...
          <li>
            <a
              href="https://github.com/MhdNour24"
              rel="noreferrer"
              target="_blank"
              className="text-gray-700 transition hover:text-gray-700/75"
            >
          ...
          <li>
            <a
              href="https://leetcode.com/u/mohmaadnoor7/"
              rel="noreferrer"
              target="_blank"
              className="text-gray-700 transition hover:text-gray-700/75"
            >
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/mhd-nour-eddin-bassal-30751416b/"
              rel="noreferrer"
              target="_blank"
              className="text-gray-700 transition hover:text-gray-700/75"
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M19 0h-14a5 5 0 00-5 5v14a5 5 0 005 5h14a5 5 0 005-5v-14a5 5 0 00-5-5zm-9 17h-3v-8h3v8zm-1.5-9.3a1.8 1.8 0 11-.001-3.6 1.8 1.8 0 01.001 3.6zm10.5 9.3h-3v-4c0-1.1-.9-2-2-2s-2 .9-2 2v4h-3v-8h3v1.1c.591-.68 1.47-1.1 2.4-1.1 1.93 0 3.5 1.57 3.5 3.5v4.5z"
                  clipRule="evenodd"
                />
              </svg>
            </a>
