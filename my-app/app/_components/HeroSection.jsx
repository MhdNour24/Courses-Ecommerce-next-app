      ...
      <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <a
              className="block w-full rounded px-12 py-3 text-sm font-medium text-teal-600 shadow hover:text-green-200 focus:outline-none focus:ring active:text-red-500 sm:w-auto"
            >
              Learn More
            </a>
          </div>
